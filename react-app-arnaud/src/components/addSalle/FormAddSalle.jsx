        ...
        <section className={style.section}>
            <form className={style.form}>
                ...
                <div className={style.divColumn}>
                    ...
                    <input className={`${style.inputName} ${style.input}` } type="text" name="name" id="name" />
                </div>
                <div className={style.div}>
                    <p className={style.partie}>Adresse*</p>
                    <div className={style.divColumn}>
                        <label className={`${style.labelNumAdresse} ${style.label}`} htmlFor="num">Numéro :</label>
                        <input className={style.input} type="text" name="" id="num" />
                    </div>
                    <div className={style.divColumn}>
                        <label className={style.label} htmlFor="voie">Voie :</label>
                        <input className={style.input} type="text" name="voie" id="voie" />
                    </div>
                    <div className={style.divColumn}>
                        <label className={style.label} htmlFor="postal">Code postal :</label>
                        <input className={`${style.inputCodePostal} ${style.input}`} type="number" name="postal" id="postal" />
                    </div>                    
                    <div className={style.divColumn}>
                        <label className={style.label} htmlFor="ville">Ville :</label>
                        <input className={style.input} type="text" name="ville" id="ville" />
                    </div>
                </div>
                <div>
                    ...
                    <div>
                        ...
                        <div className={style.divSep}>
                            ...
                            <input className={`${style.inputCoord} ${style.input}`} type="text" name="coordonnées-y" id="coordonnées-y" />
                        </div>
                    </div>
                </div>
                <div className={style.div}>
                ...
                <div className={style.div}>
                    ...
                    <input className={`${style.inputTel} ${style.input}`} type="number" name="capacite" id="capacite" />
                </div>
                <div className={style.div}>
                    ...
                    <div className={style.divRowCenter}>
                        <div className={style.divSepSmac}>
                            ...
                            <input className={style.input} type="radio" name="sm" id="smac" />
                        </div>
                        <div className={style.divSepSmac}>
                            <label className={`${style.labelSmac} ${style.label}`} htmlFor="smac-non">Non</label>
                            <input className={style.input} type="radio" name="sm" id="smac-non" />
                        </div>
                    </div>
                </div>
                <div>
                    <label className={style.partie} htmlFor="style">Styles*</label>
                    <input className={style.input} type="text" name="style" id="style" />
                </div>
