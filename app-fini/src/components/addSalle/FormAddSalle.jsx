...
//#endregion
    ...
    useEffect(() => {
            if (id != 0) {
                ...
                .then((res) => {
                    ...
                    if (res.data.listeAvis) {
                        setListeAvis(res.data.listeAvis)
                    }
                })
    ...
    const handelClick = async(e) => {
      ...
      if (!errors.nomSalle && !errors.adresseNum && !errors.adresseVoie && !errors.adresseCodePostal && !errors.adresseVille && !errors.localisationX && !errors.localisationY && !errors.contactTel && !errors.capacite && !errors.smac && !errors.styles && token) {      
          ...
          const newSalle = new Salle((Number(allSalle.length) + 1),nomSalle, newAdresse, arrayStyle, listeAvis, Number(capacite), boolSmac(smac), [newContact])
